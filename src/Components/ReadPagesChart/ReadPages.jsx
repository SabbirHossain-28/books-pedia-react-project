...
const ReadPages = () => {
  ...
  return (
    <div style={{ width: '85%', height: '500px',marginTop:"40px",marginLeft:"auto",marginRight:"auto" }}>
        <div className="text-center mb-12 p-4 bg-[#1313130D] rounded-lg shadow-lg">
        <h2 className="lg:text-2xl font-work font-bold ">Bar Chart Represention About Selected Read Books Quantity and Selected Read Books Toatal Pages </h2>
        </div>
