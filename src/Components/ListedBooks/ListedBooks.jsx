...
const ListedBooks = () => {
  ...
  const handleBooksSortBy=(readListSortBy)=>{
    ...
    if(readListSortBy==="Rating"){
      const sortedTotalReadListedBooks=[...readListBookData].sort((a,b)=>b.rating - a.rating);
      const sortedTotalWishListedBooks=[...wishlistBookData].sort((a,b)=>b.rating-a.rating);
      ...
      const sortedTotalReadListedBooks=[...readListBookData].sort((a,b)=>b.totalPages-a.totalPages);
      const sortedTotalWishListedBooks=[...wishlistBookData].sort((a,b)=>b.totalPages-a.totalPages);
      setReadListBookData(sortedTotalReadListedBooks);
      setWishlistBookData(sortedTotalWishListedBooks);
    }
    else if(readListSortBy==="Year"){
      const sortedTotalReadListedBooks=[...readListBookData].sort((a,b)=>b.yearOfPublishing-a.yearOfPublishing);
      const sortedTotalWishListedBooks=[...wishlistBookData].sort((a,b)=>b.yearOfPublishing-a.yearOfPublishing);
      setReadListBookData(sortedTotalReadListedBooks);
      setWishlistBookData(sortedTotalWishListedBooks);
    }
  }
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <details className="dropdown">
        <summary className="m-1 btn bg-[#23BE0A] text-white text-lg font-work">Sort By<GoChevronDown className="text-xl"></GoChevronDown></summary>
        <ul className="p-2 shadow menu dropdown-content z-[1] bg-base-100 rounded-box w-52">
          <li>
            <a onClick={()=>handleBooksSortBy("Rating")}>Rating</a>
          </li>
          <li>
            <a onClick={()=>handleBooksSortBy("PageNumber")}>Number of Pages</a>
          </li>
          <li>
